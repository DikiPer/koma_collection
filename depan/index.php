		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 text-center">
					...
					<a data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".8" class="btn" href="routes/shop.php">Shop Now</a>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="col-md-6">
				<div class="category-box category-box-2">
					<a href="#!">
						...
						<div class="content">
							<h3 style="color: white;">Jewellery</h3>
							<p style="color: white;">Special Design Comes First</p>
						</div>
					</a>
				</div>
			</div>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						...
						<img class="img-responsive" src="../assets/images/produk/model-2-putih.jpg" alt="product-img" />
			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						<img class="img-responsive" src="../assets/images/produk/model-2-bata.jpg" alt="product-img" />
						<div class="preview-meta">
							<ul>
								<li>
									<span data-toggle="modal" data-target="#product-modal">
			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						<img class="img-responsive" src="../assets/images/produk/model-2-ijo.jpg" alt="product-img" />
						<div class="preview-meta">
							<ul>
								<li>
									<span data-toggle="modal" data-target="#product-modal">
			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						<img class="img-responsive" src="../assets/images/produk/model-2-item.jpg" alt="product-img" />
						<div class="preview-meta">
							<ul>
								<li>
									<span data-toggle="modal" data-target="#product-modal">
			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						<img class="img-responsive" src="../assets/images/produk/model-2-pink.jpg" alt="product-img" />
						<div class="preview-meta">
							<ul>
								<li>
									<span data-toggle="modal" data-target="#product-modal">
			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						<img class="img-responsive" src="../assets/images/produk/model-2-wardah.jpg" alt="product-img" sizes="500 600" />
						<div class="preview-meta">
							<ul>
								<li>
									<span data-toggle="modal" data-target="#product-modal">

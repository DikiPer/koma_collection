...
<head>
	<base href="../../../">
	<meta charset="utf-8" />
	<title>ECommerce Checkout | KOMA</title>
								...
								<div class="flex-row-fluid ml-lg-8">
									...
									<div class="card card-custom gutter-b">
										...
										<div class="card-body d-flex rounded bg-danger p-12 flex-column flex-md-row flex-lg-column flex-xxl-row">
											<!--begin::Image-->
											<div class="bgi-no-repeat bgi-position-center bgi-size-cover h-300px h-md-auto h-lg-300px h-xxl-auto mw-100 w-550px" style="background-image: url('assets/media/products/12.png')"></div>
											<!--end::Image-->
											<!--begin::Card-->
	...
	<div id="kt_demo_panel" class="offcanvas offcanvas-right p-10">
		...
		<div class="offcanvas-content">
			...
			<div class="offcanvas-wrapper mb-5 scroll-pull">
				...
				<br />
				<b>Notice</b>: Undefined index: demo2 in
				<b>C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist\inc\view\partials\layout\extras\offcanvas\demo-panel.php</b>on line
				<b>51</b>
				<br />
				<br />

                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h5 class="mb-0 font-weight-bold text-primary">Add Products</h5>
                                            ...
                                            <form class="user" action="" method="POST" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-user"
                                                        placeholder="Enter Name" name="nama_produk">
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-user"
                                                        placeholder="Enter Price" name="harga_produk">
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-user"
                                                        placeholder="Description" name="deskripsi">
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-user"
                                                        name="kode_produk" placeholder="Product Code">
                                                </div>
                                                <div class="form-group">
                                                    <input type="number" class="form-control form-control-user"
                                                        name="stok_produk" placeholder="Product Stock">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <input type="file" class="form-control-user"
                                                        placeholder="Upload File" name="gambar_produk"
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if ($ukuran_gambar > 5000000) {
                        ...
                        if (move_uploaded_file($_FILES['gambar_produk']['tmp_name'], $target_path)) {
                            ...
                            $sql = mysqli_query($koneksi, "INSERT INTO data_produk(nama_produk,harga_produk,deskripsi,kode_produk,stok_produk,category,gambar_produk) VALUES('$nama_produk', '$harga_produk', '$deskripsi', '$kode_produk', '$stok_produk', '$category', '$nama_gambar')");
                            echo "<script>

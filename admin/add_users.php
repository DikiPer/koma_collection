                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h5 class="mb-0 font-weight-bold text-primary">Add User</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="p-5">
                                            ...
                                            <form class="user" method="POST" action="../login/cek_regist.php">
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-user"
                                                        id="exampleInputName" aria-describedby="emailHelp"
                                                        placeholder="Enter Name" name="nama_user">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-user"
                                                        id="exampleInputNoTlp" placeholder="Phone Number">
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" class="form-control form-control-user"
                                                        id="no_tlp" placeholder="Username">
                                                </div>
                                                <div class="form-group">
                                                    <input type="hidden" class="form-control form-control-user"
                                                        id="tgl_regist" value="" name="tgl_regist">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <button class="btn btn-primary btn-user btn-block" name="submit">Add
                                                    User</button>
                                                <hr>

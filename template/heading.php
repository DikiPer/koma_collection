                ...
                <div class="col-md-4 col-xs-12 col-sm-4">
                    ...
                    <ul class="top-menu text-right list-inline">
                        ...
                        <li class="dropdown">
                            ...
                            <a href="../login/index.php"><img src="../assets/images/user.png" alt="user" width="20px">
                                Login</a>
                        </li>
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse text-center">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown ">
                            <a href="../products/onsale.php">On Sale</a>
                        </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 mb-sm-3">
                                        <ul>
                                            ...
                                            <li role="separator" class="divider"></li>
                                            <li><a href="https://www.tokopedia.com/komacollection"
                                                    target="blank">Tokopedia</a></li>
                                            <li><a href="https://shopee.co.id/komacollection?smtt=0.847273526-1661225991.9"
                                    ...
                                    <div class="col-lg-6 col-md-6 mb-sm-3">
                                        <ul>
                                            ...
                                            <li role="separator" class="divider"></li>
                                            <li><a href="https://www.instagram.com/collectionkoma/"
                                                    target="blank">Instagram</a></li>
                                            <li><a href="https://www.facebook.com/profile.php?id=100084770293751"
                                                    target="blank">Facebook</a></li>
                                            <li><a href="#" target="blank">Tiktok</a></li>
                                        </ul>
                                    </div>
                    </ul><!-- / .nav .navbar-nav -->
